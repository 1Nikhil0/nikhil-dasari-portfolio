...
import { ArrowUpRight, Mail, MapPin, Phone, Linkedin, Github, Award, Code2, Layers, Zap } from "lucide-react";
...
const fadeUp = {
  ...
  visible: (i = 0) => ({ opacity: 1, y: 0, transition: { duration: 0.7, delay: i * 0.08, ease: [0.65, 0, 0.35, 1] } }),
};
